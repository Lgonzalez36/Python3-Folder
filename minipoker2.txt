...
# the player can fully see their two cards          
        ...
        while(True):
            ...
            if ((p1.getScore() == 21) or (p2.getScore() > 21 and p1.getScore() < 21)):
                ...
                print("                              ")
                print("******",p1.name, "wins!", "******")
                print("_____________1_________________")
                p1.wallet = p1.wallet + player1Bet * 2
                p2.wallet = p2.wallet - player1Bet
                player1wallet = p1.wallet
                DealerWallet = p2.wallet
                ...
                print("                              ")
                print("******", p2.name, "wins!", "******")
                print("_____________2_________________")
                p2.wallet = p2.wallet + player1Bet 
                player1wallet = p1.wallet
                DealerWallet = p2.wallet
                p1.show()
                p2.show()
                break
            elif ((p1.getScore() < 21 and p2.getScore() < 21) and p1.nCards == 5):
                print("______________________________")
                print("                              ")
                print("******",p1.name, "wins!", "******")
                print("_______________3_______________")
                p1.wallet = p1.wallet + player1Bet * 2
                p2.wallet = p2.wallet - player1Bet
                player1wallet = p1.wallet
                DealerWallet = p2.wallet
                ...
                print("                              ")
                print("******", p2.name, "wins!", "******")
                print("_______________4_______________")
                p2.wallet = p2.wallet + player1Bet 
                player1wallet = p1.wallet
                DealerWallet = p2.wallet
                p1.show()
